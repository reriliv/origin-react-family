// <style type="text/css" id="less:color">/* stylelint-disable at-rule-empty-line-before,at-rule-name-space-after,at-rule-no-unknown */
...
//   color: #2f54eb;
// }
// .page2-product .product-block .block-text-wrapper .more-mobile-react,
// .page2-product .product-block .block-text-wrapper .more-mobile-angular {
//   color: #2f54eb;
// }
...
//   box-shadow: 0 0 0 1px #fadb14 inset;
// }
...
//   background: linear-gradient(to right, #fadb14, #fadb14);
// }
...
//   border-color: #ffec3d;
//   box-shadow: -1px 0 0 0 #ffec3d;
//   color: #ffec3d;
// }
// .ant-radio-button-wrapper-checked:active {
//   border-color: #d4b106;
//   box-shadow: -1px 0 0 0 #d4b106;
//   color: #d4b106;
// }
